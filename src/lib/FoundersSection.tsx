...
export function CountdownBanner() {
  const timeLeft = useCountdown()
  return (
    <div style={{ background: '#B89B5E', padding: '10px 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', flexWrap: 'wrap', minHeight: '44px', position: 'fixed' as const, top: 0, left: 0, right: 0, zIndex: 200, width: '100%', marginTop: '64px' }}>
